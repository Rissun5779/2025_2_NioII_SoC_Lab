...
module Nios2_mm_interconnect_0 (
	...
	wire   [23:0] cpu_data_master_translator_avalon_universal_master_0_address;              // CPU_data_master_translator:uav_address -> CPU_data_master_agent:av_address
	...
	wire   [23:0] cpu_instruction_master_translator_avalon_universal_master_0_address;       // CPU_instruction_master_translator:uav_address -> CPU_instruction_master_agent:av_address
	...
	wire   [23:0] juart_avalon_jtag_slave_agent_m0_address;                                  // JUART_avalon_jtag_slave_agent:m0_address -> JUART_avalon_jtag_slave_translator:uav_address
	...
	wire  [100:0] juart_avalon_jtag_slave_agent_rf_source_data;                              // JUART_avalon_jtag_slave_agent:rf_source_data -> JUART_avalon_jtag_slave_agent_rsp_fifo:in_data
	...
	wire  [100:0] juart_avalon_jtag_slave_agent_rsp_fifo_out_data;                           // JUART_avalon_jtag_slave_agent_rsp_fifo:out_data -> JUART_avalon_jtag_slave_agent:rf_sink_data
	...
	wire   [99:0] cmd_mux_src_data;                                                          // cmd_mux:src_data -> JUART_avalon_jtag_slave_agent:cp_data
	wire          cmd_mux_src_ready;                                                         // JUART_avalon_jtag_slave_agent:cp_ready -> cmd_mux:src_ready
	wire    [5:0] cmd_mux_src_channel;                                                       // cmd_mux:src_channel -> JUART_avalon_jtag_slave_agent:cp_channel
	...
	wire   [23:0] cpu_debug_mem_slave_agent_m0_address;                                      // CPU_debug_mem_slave_agent:m0_address -> CPU_debug_mem_slave_translator:uav_address
	...
	wire   [99:0] cmd_mux_002_src_data;                                                      // cmd_mux_002:src_data -> RAM_s1_agent:cp_data
	...
	wire   [99:0] cmd_mux_003_src_data;                                                      // cmd_mux_003:src_data -> PIO_LED_s1_agent:cp_data
	...
	wire   [23:0] pio_sw_s1_agent_m0_address;                                                // PIO_SW_s1_agent:m0_address -> PIO_SW_s1_translator:uav_address
	...
	wire  [100:0] pio_sw_s1_agent_rf_source_data;                                            // PIO_SW_s1_agent:rf_source_data -> PIO_SW_s1_agent_rsp_fifo:in_data
	...
	wire  [100:0] pio_sw_s1_agent_rsp_fifo_out_data;                                         // PIO_SW_s1_agent_rsp_fifo:out_data -> PIO_SW_s1_agent:rf_sink_data
	...
	wire   [99:0] cmd_mux_004_src_data;                                                      // cmd_mux_004:src_data -> PIO_SW_s1_agent:cp_data
	...
	wire   [99:0] juart_avalon_jtag_slave_agent_rp_data;                                     // JUART_avalon_jtag_slave_agent:rp_data -> router_002:sink_data
	...
	wire   [99:0] ram_s1_agent_rp_data;                                                      // RAM_s1_agent:rp_data -> router_004:sink_data
	...
	wire   [99:0] pio_led_s1_agent_rp_data;                                                  // PIO_LED_s1_agent:rp_data -> router_005:sink_data
	...
	wire   [99:0] pio_sw_s1_agent_rp_data;                                                   // PIO_SW_s1_agent:rp_data -> router_006:sink_data
	...
	wire   [81:0] sdram_s1_agent_rp_data;                                                    // SDRAM_s1_agent:rp_data -> router_007:sink_data
	...
	wire   [81:0] router_007_src_data;                                                       // router_007:src_data -> SDRAM_s1_rsp_width_adapter:in_data
	...
	wire   [99:0] sdram_s1_rsp_width_adapter_src_data;                                       // SDRAM_s1_rsp_width_adapter:out_data -> rsp_demux_005:sink_data
	...
	wire   [99:0] cmd_mux_005_src_data;                                                      // cmd_mux_005:src_data -> SDRAM_s1_cmd_width_adapter:in_data
	...
	Nios2_mm_interconnect_0_cmd_mux_005 cmd_mux_005 (
		.clk                 (CLK_clk_clk),                           //       clk.clk
		.reset               (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Nios2_mm_interconnect_0_rsp_demux_005 rsp_demux_005 (
		.clk                (CLK_clk_clk),                                  //       clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset),        // clk_reset.reset
