...
# ----------------------------------------
# If Nios2 is one of several IP cores in your
...
# ----------------------------------------
# ACDS 18.1 625 win32 2026.03.02.12:54:18
...
if ![info exists QUARTUS_INSTALL_DIR] { 
  set QUARTUS_INSTALL_DIR "K:/quartus18/quartus/"
}
...
alias file_copy {
  echo "\[exec\] file_copy"
  file copy -force $QSYS_SIMDIR/submodules/Nios2_CPU_cpu_ociram_default_contents.dat ./
  file copy -force $QSYS_SIMDIR/submodules/Nios2_CPU_cpu_ociram_default_contents.hex ./
  file copy -force $QSYS_SIMDIR/submodules/Nios2_CPU_cpu_ociram_default_contents.mif ./
  file copy -force $QSYS_SIMDIR/submodules/Nios2_CPU_cpu_rf_ram_a.dat ./
  file copy -force $QSYS_SIMDIR/submodules/Nios2_CPU_cpu_rf_ram_a.hex ./
  file copy -force $QSYS_SIMDIR/submodules/Nios2_CPU_cpu_rf_ram_a.mif ./
  file copy -force $QSYS_SIMDIR/submodules/Nios2_CPU_cpu_rf_ram_b.dat ./
  file copy -force $QSYS_SIMDIR/submodules/Nios2_CPU_cpu_rf_ram_b.hex ./
  file copy -force $QSYS_SIMDIR/submodules/Nios2_CPU_cpu_rf_ram_b.mif ./
  file copy -force $QSYS_SIMDIR/submodules/Nios2_RAM.hex ./
}
...
ensure_lib                                        ./libraries/JUART_avalon_jtag_slave_agent_rsp_fifo/
vmap       JUART_avalon_jtag_slave_agent_rsp_fifo ./libraries/JUART_avalon_jtag_slave_agent_rsp_fifo/
ensure_lib                                        ./libraries/JUART_avalon_jtag_slave_agent/         
vmap       JUART_avalon_jtag_slave_agent          ./libraries/JUART_avalon_jtag_slave_agent/         
ensure_lib                                        ./libraries/CPU_data_master_agent/                 
vmap       CPU_data_master_agent                  ./libraries/CPU_data_master_agent/                 
ensure_lib                                        ./libraries/JUART_avalon_jtag_slave_translator/    
vmap       JUART_avalon_jtag_slave_translator     ./libraries/JUART_avalon_jtag_slave_translator/    
...
ensure_lib                                        ./libraries/JUART/                                 
vmap       JUART                                  ./libraries/JUART/                                 
ensure_lib                                        ./libraries/CPU/                                   
vmap       CPU                                    ./libraries/CPU/                                   
...
alias com {
  echo "\[exec\] com"
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/Nios2_mm_interconnect_0_avalon_st_adapter_006_error_adapter_0.sv" -work error_adapter_0                       
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/Nios2_mm_interconnect_0_avalon_st_adapter_error_adapter_0.sv"     -work error_adapter_0                       
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS        "$QSYS_SIMDIR/submodules/Nios2_mm_interconnect_0_avalon_st_adapter_006.vhd"                -work avalon_st_adapter_006                 
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS        "$QSYS_SIMDIR/submodules/Nios2_mm_interconnect_0_avalon_st_adapter.vhd"                    -work avalon_st_adapter                     
  ...
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/Nios2_mm_interconnect_0_rsp_mux.sv"                               -work rsp_mux                               
  ...
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/Nios2_mm_interconnect_0_rsp_demux_006.sv"                         -work rsp_demux_006                         
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/Nios2_mm_interconnect_0_rsp_demux.sv"                             -work rsp_demux                             
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/Nios2_mm_interconnect_0_cmd_mux.sv"                               -work cmd_mux                               
  ...
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/Nios2_mm_interconnect_0_cmd_demux.sv"                             -work cmd_demux                             
  ...
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/Nios2_mm_interconnect_0_router_008.sv"                            -work router_008                            
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/Nios2_mm_interconnect_0_router_002.sv"                            -work router_002                            
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/Nios2_mm_interconnect_0_router.sv"                                -work router                                
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/altera_avalon_sc_fifo.v"                                          -work JUART_avalon_jtag_slave_agent_rsp_fifo
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_slave_agent.sv"                                     -work JUART_avalon_jtag_slave_agent         
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_burst_uncompressor.sv"                              -work JUART_avalon_jtag_slave_agent         
  ...
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_slave_translator.sv"                                -work JUART_avalon_jtag_slave_translator    
  ...
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/Nios2_CPU_cpu.v"                                                  -work cpu                                   
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/Nios2_CPU_cpu_debug_slave_sysclk.v"                               -work cpu                                   
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/Nios2_CPU_cpu_debug_slave_tck.v"                                  -work cpu                                   
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/Nios2_CPU_cpu_debug_slave_wrapper.v"                              -work cpu                                   
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/Nios2_CPU_cpu_test_bench.v"                                       -work cpu                                   
  ...
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/Nios2_irq_mapper.sv"                                              -work irq_mapper                            
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/Nios2_mm_interconnect_0.v"                                        -work mm_interconnect_0                     
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/Nios2_sysid_qsys_0.v"                                             -work sysid_qsys_0                          
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS        "$QSYS_SIMDIR/submodules/Nios2_SDRAM.vhd"                                                  -work SDRAM                                 
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS        "$QSYS_SIMDIR/submodules/Nios2_RAM.vhd"                                                    -work RAM                                   
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS        "$QSYS_SIMDIR/submodules/Nios2_PLL.vho"                                                    -work PLL                                   
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS        "$QSYS_SIMDIR/submodules/Nios2_PIO_SW.vhd"                                                 -work PIO_SW                                
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS        "$QSYS_SIMDIR/submodules/Nios2_PIO_LED.vhd"                                                -work PIO_LED                               
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS        "$QSYS_SIMDIR/submodules/Nios2_JUART.vhd"                                                  -work JUART                                 
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/Nios2_CPU.v"                                                      -work CPU                                   
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS        "$QSYS_SIMDIR/Nios2.vhd"                                                                                                               
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS        "$QSYS_SIMDIR/nios2_rst_controller.vhd"                                                                                                
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS        "$QSYS_SIMDIR/nios2_rst_controller_001.vhd"                                                                                            
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS        "$QSYS_SIMDIR/nios2_rst_controller_002.vhd"                                                                                            
}
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L error_adapter_0 -L avalon_st_adapter_006 -L avalon_st_adapter -L crosser -L SDRAM_s1_rsp_width_adapter -L rsp_mux -L rsp_demux_006 -L rsp_demux -L cmd_mux -L cmd_demux -L SDRAM_s1_burst_adapter -L router_008 -L router_002 -L router -L JUART_avalon_jtag_slave_agent_rsp_fifo -L JUART_avalon_jtag_slave_agent -L CPU_data_master_agent -L JUART_avalon_jtag_slave_translator -L CPU_data_master_translator -L cpu -L rst_controller -L irq_mapper -L mm_interconnect_0 -L sysid_qsys_0 -L SDRAM -L RAM -L PLL -L PIO_SW -L PIO_LED -L JUART -L CPU -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cyclonev $TOP_LEVEL_NAME
}
