...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/Nios2_mm_interconnect_0_avalon_st_adapter_005_error_adapter_0.sv" -work error_adapter_0                        -cdslib ./cds_libs/error_adapter_0.cds.lib                       
  ...
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/Nios2_mm_interconnect_0_avalon_st_adapter_005.vhd"                -work avalon_st_adapter_005                  -cdslib ./cds_libs/avalon_st_adapter_005.cds.lib                 
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/Nios2_mm_interconnect_0_rsp_demux_005.sv"                         -work rsp_demux_005                          -cdslib ./cds_libs/rsp_demux_005.cds.lib                         
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/Nios2_mm_interconnect_0_router_007.sv"                            -work router_007                             -cdslib ./cds_libs/router_007.cds.lib                            
