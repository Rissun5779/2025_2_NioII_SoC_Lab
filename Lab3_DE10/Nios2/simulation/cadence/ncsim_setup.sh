...
QSYS_SIMDIR="./../"
QUARTUS_INSTALL_DIR="K:/quartus18/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
mkdir -p ./libraries/JUART_avalon_jtag_slave_agent/
mkdir -p ./libraries/CPU_data_master_agent/
mkdir -p ./libraries/JUART_avalon_jtag_slave_translator/
...
if [ $SKIP_FILE_COPY -eq 0 ]; then
  cp -f $QSYS_SIMDIR/submodules/Nios2_CPU_cpu_ociram_default_contents.dat ./
  cp -f $QSYS_SIMDIR/submodules/Nios2_CPU_cpu_ociram_default_contents.hex ./
  cp -f $QSYS_SIMDIR/submodules/Nios2_CPU_cpu_ociram_default_contents.mif ./
  cp -f $QSYS_SIMDIR/submodules/Nios2_CPU_cpu_rf_ram_a.dat ./
  cp -f $QSYS_SIMDIR/submodules/Nios2_CPU_cpu_rf_ram_a.hex ./
  cp -f $QSYS_SIMDIR/submodules/Nios2_CPU_cpu_rf_ram_a.mif ./
  cp -f $QSYS_SIMDIR/submodules/Nios2_CPU_cpu_rf_ram_b.dat ./
  cp -f $QSYS_SIMDIR/submodules/Nios2_CPU_cpu_rf_ram_b.hex ./
  cp -f $QSYS_SIMDIR/submodules/Nios2_CPU_cpu_rf_ram_b.mif ./
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/Nios2_mm_interconnect_0_avalon_st_adapter_006_error_adapter_0.sv" -work error_adapter_0                        -cdslib ./cds_libs/error_adapter_0.cds.lib                       
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/Nios2_mm_interconnect_0_avalon_st_adapter_error_adapter_0.sv"     -work error_adapter_0                        -cdslib ./cds_libs/error_adapter_0.cds.lib                       
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/Nios2_mm_interconnect_0_avalon_st_adapter_006.vhd"                -work avalon_st_adapter_006                  -cdslib ./cds_libs/avalon_st_adapter_006.cds.lib                 
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/Nios2_mm_interconnect_0_avalon_st_adapter.vhd"                    -work avalon_st_adapter                      -cdslib ./cds_libs/avalon_st_adapter.cds.lib                     
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/Nios2_mm_interconnect_0_rsp_mux.sv"                               -work rsp_mux                                -cdslib ./cds_libs/rsp_mux.cds.lib                               
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/Nios2_mm_interconnect_0_rsp_demux_006.sv"                         -work rsp_demux_006                          -cdslib ./cds_libs/rsp_demux_006.cds.lib                         
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/Nios2_mm_interconnect_0_rsp_demux.sv"                             -work rsp_demux                              -cdslib ./cds_libs/rsp_demux.cds.lib                             
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/Nios2_mm_interconnect_0_cmd_mux.sv"                               -work cmd_mux                                -cdslib ./cds_libs/cmd_mux.cds.lib                               
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/Nios2_mm_interconnect_0_cmd_demux.sv"                             -work cmd_demux                              -cdslib ./cds_libs/cmd_demux.cds.lib                             
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/Nios2_mm_interconnect_0_router_008.sv"                            -work router_008                             -cdslib ./cds_libs/router_008.cds.lib                            
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/Nios2_mm_interconnect_0_router_002.sv"                            -work router_002                             -cdslib ./cds_libs/router_002.cds.lib                            
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/Nios2_mm_interconnect_0_router.sv"                                -work router                                 -cdslib ./cds_libs/router.cds.lib                                
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/altera_avalon_sc_fifo.v"                                          -work JUART_avalon_jtag_slave_agent_rsp_fifo -cdslib ./cds_libs/JUART_avalon_jtag_slave_agent_rsp_fifo.cds.lib
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_slave_agent.sv"                                     -work JUART_avalon_jtag_slave_agent          -cdslib ./cds_libs/JUART_avalon_jtag_slave_agent.cds.lib         
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_burst_uncompressor.sv"                              -work JUART_avalon_jtag_slave_agent          -cdslib ./cds_libs/JUART_avalon_jtag_slave_agent.cds.lib         
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_slave_translator.sv"                                -work JUART_avalon_jtag_slave_translator     -cdslib ./cds_libs/JUART_avalon_jtag_slave_translator.cds.lib    
  ...
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/Nios2_CPU_cpu.v"                                                  -work cpu                                    -cdslib ./cds_libs/cpu.cds.lib                                   
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/Nios2_CPU_cpu_debug_slave_sysclk.v"                               -work cpu                                    -cdslib ./cds_libs/cpu.cds.lib                                   
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/Nios2_CPU_cpu_debug_slave_tck.v"                                  -work cpu                                    -cdslib ./cds_libs/cpu.cds.lib                                   
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/Nios2_CPU_cpu_debug_slave_wrapper.v"                              -work cpu                                    -cdslib ./cds_libs/cpu.cds.lib                                   
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/Nios2_CPU_cpu_test_bench.v"                                       -work cpu                                    -cdslib ./cds_libs/cpu.cds.lib                                   
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/Nios2_irq_mapper.sv"                                              -work irq_mapper                             -cdslib ./cds_libs/irq_mapper.cds.lib                            
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/Nios2_mm_interconnect_0.v"                                        -work mm_interconnect_0                      -cdslib ./cds_libs/mm_interconnect_0.cds.lib                     
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/Nios2_sysid_qsys_0.v"                                             -work sysid_qsys_0                           -cdslib ./cds_libs/sysid_qsys_0.cds.lib                          
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/Nios2_SDRAM.vhd"                                                  -work SDRAM                                  -cdslib ./cds_libs/SDRAM.cds.lib                                 
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/Nios2_RAM.vhd"                                                    -work RAM                                    -cdslib ./cds_libs/RAM.cds.lib                                   
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/Nios2_PLL.vho"                                                    -work PLL                                    -cdslib ./cds_libs/PLL.cds.lib                                   
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/Nios2_PIO_SW.vhd"                                                 -work PIO_SW                                 -cdslib ./cds_libs/PIO_SW.cds.lib                                
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/Nios2_PIO_LED.vhd"                                                -work PIO_LED                                -cdslib ./cds_libs/PIO_LED.cds.lib                               
  ...
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/nios2_rst_controller_002.vhd"                                                                                                                                                              
fi
