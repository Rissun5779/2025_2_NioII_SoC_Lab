...
module Nios2_mm_interconnect_0 (
	...
	wire    [6:0] cmd_mux_src_channel;                                                       // cmd_mux:src_channel -> JUART_avalon_jtag_slave_agent:cp_channel
	...
	wire  [100:0] cmd_mux_005_src_data;                                                      // cmd_mux_005:src_data -> PIO_SW_s1_agent:cp_data
	wire          cmd_mux_005_src_ready;                                                     // PIO_SW_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire    [6:0] cmd_mux_005_src_channel;                                                   // cmd_mux_005:src_channel -> PIO_SW_s1_agent:cp_channel
	...
	wire  [100:0] pio_sw_s1_agent_rp_data;                                                   // PIO_SW_s1_agent:rp_data -> router_007:sink_data
	...
	wire  [100:0] cmd_demux_src6_data;                                                       // cmd_demux:src6_data -> crosser:in_data
	...
	wire  [100:0] crosser_out_data;                                                          // crosser:out_data -> cmd_mux_006:sink0_data
	...
	wire  [100:0] crosser_001_out_data;                                                      // crosser_001:out_data -> cmd_mux_006:sink1_data
	...
	wire  [100:0] rsp_demux_006_src0_data;                                                   // rsp_demux_006:src0_data -> crosser_002:in_data
	...
	wire  [100:0] crosser_002_out_data;                                                      // crosser_002:out_data -> rsp_mux:sink6_data
	...
	wire  [100:0] rsp_demux_006_src1_data;                                                   // rsp_demux_006:src1_data -> crosser_003:in_data
