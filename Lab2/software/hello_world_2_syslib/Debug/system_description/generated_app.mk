...
# d:\2025_2\2025_2_NioII_SoC_Lab\Lab2\software\hello_world_2_syslib\..\..\Nios2.ptf
#
# Generated: 2026-03-12 17:13:11.808
...
QUARTUS_PROJECT_DIR = D:/2025_2/2025_2_NioII_SoC_Lab/Lab2

# the simulation directory is a subdirectory of the PTF directory
SIMDIR = $(QUARTUS_PROJECT_DIR)/Nios2_sim
...
hex: $(QUARTUS_PROJECT_DIR)/RAM.hex
.PHONY: hex
...
$(QUARTUS_PROJECT_DIR)/RAM.hex: $(ELF)
	@echo Post-processing to create $(notdir $@)
	elf2hex $(ELF) 0x00010000 0x19FFF --width=32 $(QUARTUS_PROJECT_DIR)/RAM.hex --create-lanes=0
...
generated_app_clean:
	$(RM) $(QUARTUS_PROJECT_DIR)/RAM.hex
