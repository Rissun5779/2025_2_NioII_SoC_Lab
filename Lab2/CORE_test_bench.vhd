...
end entity CORE_test_bench;


architecture europa of CORE_test_bench is
...
--synthesis translate_off
      ...
      if clk'event and clk = '1' then
        if std_logic'(reset_n) = '1' then 
          if is_x(std_ulogic(F_valid)) then 
            ...
            write(write_line, string'("ERROR: CORE_test_bench/F_valid is 'x'"));
      ...
      if clk'event and clk = '1' then
        if std_logic'(reset_n) = '1' then 
          if is_x(std_ulogic(D_valid)) then 
            ...
            write(write_line1, string'("ERROR: CORE_test_bench/D_valid is 'x'"));
      ...
      if clk'event and clk = '1' then
        if std_logic'(reset_n) = '1' then 
          if is_x(std_ulogic(E_valid)) then 
            ...
            write(write_line2, string'("ERROR: CORE_test_bench/E_valid is 'x'"));
      ...
      if clk'event and clk = '1' then
        if std_logic'(reset_n) = '1' then 
          if is_x(std_ulogic(W_valid)) then 
            ...
            write(write_line3, string'("ERROR: CORE_test_bench/W_valid is 'x'"));
      ...
      if reset_n = '0' then
        ...
        if std_logic'(W_valid) = '1' then 
          if is_x(std_ulogic(R_wr_dst_reg)) then 
            ...
            write(write_line4, string'("ERROR: CORE_test_bench/R_wr_dst_reg is 'x'"));
      ...
      if reset_n = '0' then
        ...
        if std_logic'((W_valid AND R_wr_dst_reg)) = '1' then 
          if is_x(W_wr_data) then 
            ...
            write(write_line5, string'("ERROR: CORE_test_bench/W_wr_data is 'x'"));
      ...
      if reset_n = '0' then
        ...
        if std_logic'((W_valid AND R_wr_dst_reg)) = '1' then 
          if is_x(R_dst_regnum) then 
            ...
            write(write_line6, string'("ERROR: CORE_test_bench/R_dst_regnum is 'x'"));
      ...
      if reset_n = '0' then
        ...
        if std_logic'((W_valid AND R_ctrl_ld)) = '1' then 
          if is_x(R_dst_regnum) then 
            ...
            write(write_line7, string'("ERROR: CORE_test_bench/R_dst_regnum is 'x'"));
      ...
      if clk'event and clk = '1' then
        if std_logic'(reset_n) = '1' then 
          if is_x(std_ulogic(internal_d_write1)) then 
            ...
            write(write_line8, string'("ERROR: CORE_test_bench/internal_d_write1 is 'x'"));
      ...
      if reset_n = '0' then
        ...
        if std_logic'(internal_d_write1) = '1' then 
          if is_x(d_byteenable) then 
            ...
            write(write_line9, string'("ERROR: CORE_test_bench/d_byteenable is 'x'"));
      ...
      if reset_n = '0' then
        ...
        if std_logic'((internal_d_write1 OR d_read)) = '1' then 
          if is_x(d_address) then 
            ...
            write(write_line10, string'("ERROR: CORE_test_bench/d_address is 'x'"));
      ...
      if clk'event and clk = '1' then
        if std_logic'(reset_n) = '1' then 
          if is_x(std_ulogic(d_read)) then 
            ...
            write(write_line11, string'("ERROR: CORE_test_bench/d_read is 'x'"));
      ...
      if clk'event and clk = '1' then
        if std_logic'(reset_n) = '1' then 
          if is_x(std_ulogic(i_read)) then 
            ...
            write(write_line12, string'("ERROR: CORE_test_bench/i_read is 'x'"));
      ...
      if reset_n = '0' then
        ...
        if std_logic'(i_read) = '1' then 
          if is_x(i_address) then 
            ...
            write(write_line13, string'("ERROR: CORE_test_bench/i_address is 'x'"));
      ...
      if reset_n = '0' then
        ...
        if std_logic'((i_read AND NOT i_waitrequest)) = '1' then 
          if is_x(i_readdata) then 
            ...
            write(write_line14, string'("ERROR: CORE_test_bench/i_readdata is 'x'"));
      ...
      if reset_n = '0' then
        ...
        if std_logic'((W_valid AND R_ctrl_ld)) = '1' then 
          if is_x(av_ld_data_aligned_unfiltered) then 
            ...
            write(write_line15, string'("WARNING: CORE_test_bench/av_ld_data_aligned_unfiltered is 'x'"));
      ...
      if reset_n = '0' then
        ...
        if std_logic'((W_valid AND R_wr_dst_reg)) = '1' then 
          if is_x(W_wr_data) then 
            ...
            write(write_line16, string'("WARNING: CORE_test_bench/W_wr_data is 'x'"));
    ...
    begin  -- process
      file_open(status, trace_handle, "CORE.tr", WRITE_MODE);
