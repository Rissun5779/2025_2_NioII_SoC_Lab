...
alias file_copy {
  ...
  file copy -force $QSYS_SIMDIR/submodules/Nios2_CPU_ociram_default_contents.dat ./
  file copy -force $QSYS_SIMDIR/submodules/Nios2_CPU_ociram_default_contents.hex ./
  file copy -force $QSYS_SIMDIR/submodules/Nios2_CPU_ociram_default_contents.mif ./
  file copy -force $QSYS_SIMDIR/submodules/Nios2_CPU_rf_ram_a.dat ./
  file copy -force $QSYS_SIMDIR/submodules/Nios2_CPU_rf_ram_a.hex ./
  file copy -force $QSYS_SIMDIR/submodules/Nios2_CPU_rf_ram_a.mif ./
  file copy -force $QSYS_SIMDIR/submodules/Nios2_CPU_rf_ram_b.dat ./
  file copy -force $QSYS_SIMDIR/submodules/Nios2_CPU_rf_ram_b.hex ./
  file copy -force $QSYS_SIMDIR/submodules/Nios2_CPU_rf_ram_b.mif ./
}
...
alias com {
  ...
  vcom  "$QSYS_SIMDIR/submodules/Nios2_CPU_jtag_debug_module_translator_avalon_universal_slave_0_agent_rsp_fifo.vho" -work CPU_jtag_debug_module_translator_avalon_universal_slave_0_agent_rsp_fifo
  ...
  vcom  "$QSYS_SIMDIR/submodules/Nios2_PIO_LED.vhd"                                                                  -work PIO_LED                                                                 
  vcom  "$QSYS_SIMDIR/submodules/Nios2_JUART.vhd"                                                                    -work JUART                                                                   
  vcom  "$QSYS_SIMDIR/submodules/Nios2_RAM.vhd"                                                                      -work RAM                                                                     
  vcom  "$QSYS_SIMDIR/submodules/Nios2_CPU.vhd"                                                                      -work CPU                                                                     
  vcom  "$QSYS_SIMDIR/submodules/Nios2_CPU_jtag_debug_module_sysclk.vhd"                                             -work CPU                                                                     
  vcom  "$QSYS_SIMDIR/submodules/Nios2_CPU_jtag_debug_module_tck.vhd"                                                -work CPU                                                                     
  vcom  "$QSYS_SIMDIR/submodules/Nios2_CPU_jtag_debug_module_wrapper.vhd"                                            -work CPU                                                                     
  vcom  "$QSYS_SIMDIR/submodules/Nios2_CPU_oci_test_bench.vhd"                                                       -work CPU                                                                     
  vcom  "$QSYS_SIMDIR/submodules/Nios2_CPU_test_bench.vhd"                                                           -work CPU                                                                     
  vcom  "$QSYS_SIMDIR/Nios2.vhd"                                                                                                                                                                   
  vcom  "$QSYS_SIMDIR/nios2_cpu_jtag_debug_module_translator.vhd"                                                                                                                                  
  vcom  "$QSYS_SIMDIR/nios2_ram_s1_translator.vhd"                                                                                                                                                 
  vcom  "$QSYS_SIMDIR/nios2_juart_avalon_jtag_slave_translator.vhd"                                                                                                                                
  vcom  "$QSYS_SIMDIR/nios2_pio_led_s1_translator.vhd"                                                                                                                                             
  vcom  "$QSYS_SIMDIR/nios2_cpu_instruction_master_translator.vhd"                                                                                                                                 
  vcom  "$QSYS_SIMDIR/nios2_cpu_data_master_translator.vhd"                                                                                                                                        
}
...
alias elab {
  echo "\[exec\] elab"
  vsim +access +r  -t ps -L work -L irq_mapper -L rsp_xbar_mux -L rsp_xbar_demux -L cmd_xbar_mux -L cmd_xbar_demux -L rst_controller -L id_router -L addr_router -L CPU_jtag_debug_module_translator_avalon_universal_slave_0_agent_rsp_fifo -L CPU_jtag_debug_module_translator_avalon_universal_slave_0_agent -L CPU_instruction_master_translator_avalon_universal_master_0_agent -L CPU_jtag_debug_module_translator -L CPU_instruction_master_translator -L PIO_LED -L JUART -L RAM -L CPU -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cyclonev $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  vsim -dbg -O2 +access +r -t ps -L work -L irq_mapper -L rsp_xbar_mux -L rsp_xbar_demux -L cmd_xbar_mux -L cmd_xbar_demux -L rst_controller -L id_router -L addr_router -L CPU_jtag_debug_module_translator_avalon_universal_slave_0_agent_rsp_fifo -L CPU_jtag_debug_module_translator_avalon_universal_slave_0_agent -L CPU_instruction_master_translator_avalon_universal_master_0_agent -L CPU_jtag_debug_module_translator -L CPU_instruction_master_translator -L PIO_LED -L JUART -L RAM -L CPU -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cyclonev $TOP_LEVEL_NAME
}
