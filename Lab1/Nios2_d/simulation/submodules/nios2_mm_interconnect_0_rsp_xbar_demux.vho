...
--synthesis_resources = 
 ...
 ENTITY  nios2_mm_interconnect_0_rsp_xbar_demux IS 
	 PORT 
	 ( 
		 clk	:	IN  STD_LOGIC;
		 reset	:	IN  STD_LOGIC;
 ...
 END nios2_mm_interconnect_0_rsp_xbar_demux;

 ARCHITECTURE RTL OF nios2_mm_interconnect_0_rsp_xbar_demux IS
 ...
 END RTL; --nios2_mm_interconnect_0_rsp_xbar_demux
