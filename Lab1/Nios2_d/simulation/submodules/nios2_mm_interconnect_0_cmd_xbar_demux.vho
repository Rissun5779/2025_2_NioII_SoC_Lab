...
--synthesis_resources = 
 ...
 ENTITY  nios2_mm_interconnect_0_cmd_xbar_demux IS 
	 PORT 
	 ( 
		 clk	:	IN  STD_LOGIC;
		 reset	:	IN  STD_LOGIC;
		 ...
		 src3_data	:	OUT  STD_LOGIC_VECTOR (91 DOWNTO 0);
		 src3_endofpacket	:	OUT  STD_LOGIC;
		 src3_ready	:	IN  STD_LOGIC;
		 src3_startofpacket	:	OUT  STD_LOGIC;
		 src3_valid	:	OUT  STD_LOGIC
	 ); 
 END nios2_mm_interconnect_0_cmd_xbar_demux;

 ARCHITECTURE RTL OF nios2_mm_interconnect_0_cmd_xbar_demux IS
 ...
 BEGIN
	...
	src3_data <= ( sink_data(91 DOWNTO 0));
 ...
 END RTL; --nios2_mm_interconnect_0_cmd_xbar_demux
